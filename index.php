...
<body style="background-image: url('assets/home/background-home-desktop.jpg'); margin: 0; background-size: cover; background-repeat: no-repeat; background-position: center;">
...
<nav>
    ...
    <section id="SECTIONPRINCIPALE">
        ...
        <div id="EnglobeTEXTEGAUCHE">
            <p style="letter-spacing: 4px; text-transform: uppercase; color: #ffffff; font-family:Bellefair;">So, you want to travel to</p>
                <h1 id="TitreSPACE"> Space </h1>
        ...
        <!-- Bouton Explore à droite -->
        <div id="englobeTextExplore">
            <div id="textexplore">
                Explore
            </div>
        </div>
